...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('0lA8vk8dBM', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cgDrXcy4oL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('M1LgU3OvGB', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d->addDriver(($this->privates['doctrine.orm.default_attribute_metadata_driver'] ?? ($this->privates['doctrine.orm.default_attribute_metadata_driver'] = new \Doctrine\ORM\Mapping\Driver\AttributeDriver([0 => 'E:\\website-skeleton\\src\\Entity'], false))), 'App\\Entity');
    ...
    protected function getAssets_PackagesService()
    {
        ...
        return $this->privates['assets.packages'] = new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy('E:\\website-skeleton/public/build/manifest.json', ($this->privates['.debug.http_client'] ?? $this->get_Debug_HttpClientService()), false), new \Symfony\Component\Asset\Context\RequestStackContext(($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), $a->getBaseUrl(), $a->isSecure())), new RewindableGenerator(function () {
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('J8DrLiSGjU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('15z99y31UF', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EsDWmtvtI3', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Pi9R5EltlM', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('w8fbDdb3B2', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4+Mf0mEWty', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jGiqkWW860', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1go30OraYA', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter($this->getEnv('default::SYMFONY_IDE'), ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), 'E:\\website-skeleton', #[\Closure(name: 'debug.file_link_formatter.url_format', class: 'string')] function () {
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => [0 => 'php'], 'translation.loader.yml' => [0 => 'yaml', 1 => 'yml'], 'translation.loader.xliff' => [0 => 'xlf', 1 => 'xliff'], 'translation.loader.po' => [0 => 'po'], 'translation.loader.mo' => [0 => 'mo'], 'translation.loader.qt' => [0 => 'ts'], 'translation.loader.csv' => [0 => 'csv'], 'translation.loader.res' => [0 => 'res'], 'translation.loader.dat' => [0 => 'dat'], 'translation.loader.ini' => [0 => 'ini'], 'translation.loader.json' => [0 => 'json']], ['cache_dir' => ($this->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.af.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.af.xlf'], 'ar' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf'], 'az' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.az.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.az.xlf'], 'be' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.be.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.be.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.be.xlf'], 'bg' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.bg.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.bg.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.bg.xlf'], 'bs' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.bs.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.bs.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.bs.xlf'], 'ca' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.ca.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.ca.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.ca.xlf'], 'cs' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.cs.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.cs.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.cs.xlf'], 'cy' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.cy.xlf'], 'da' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.da.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.da.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.da.xlf'], 'de' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.de.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.de.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.de.xlf'], 'el' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.el.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.el.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.el.xlf'], 'en' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.en.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.en.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.en.xlf'], 'es' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.es.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.es.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.es.xlf'], 'et' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.et.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.et.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.et.xlf'], 'eu' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.eu.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.eu.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.eu.xlf'], 'fa' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.fa.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.fa.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.fa.xlf'], 'fi' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.fi.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.fi.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.fi.xlf'], 'fr' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.fr.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.fr.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.fr.xlf'], 'gl' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.gl.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.gl.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.gl.xlf'], 'he' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.he.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.he.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.he.xlf'], 'hr' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.hr.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.hr.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.hr.xlf'], 'hu' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.hu.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.hu.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.hu.xlf'], 'hy' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.hy.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.hy.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.hy.xlf'], 'id' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.id.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.id.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.id.xlf'], 'it' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.it.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.it.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.it.xlf'], 'ja' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.ja.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.ja.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.ja.xlf'], 'lb' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.lb.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.lb.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.lb.xlf'], 'lt' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.lt.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.lt.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.lt.xlf'], 'lv' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.lv.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.lv.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.lv.xlf'], 'mn' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.mn.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.mn.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.mn.xlf'], 'my' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.my.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.my.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.my.xlf'], 'nb' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.nb.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.nb.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.nb.xlf'], 'nl' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.nl.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.nl.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.nl.xlf'], 'nn' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.nn.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.nn.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.nn.xlf'], 'no' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.no.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.no.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.no.xlf'], 'pl' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.pl.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.pl.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.pl.xlf'], 'pt' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.pt.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.pt.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.pt.xlf'], 'pt_BR' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.pt_BR.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.pt_BR.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.pt_BR.xlf'], 'ro' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.ro.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.ro.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.ro.xlf'], 'ru' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.ru.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.ru.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.ru.xlf'], 'sk' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.sk.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.sk.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.sk.xlf'], 'sl' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.sl.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.sl.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.sl.xlf'], 'sq' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.sq.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.sq.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.sq.xlf'], 'sr_Cyrl' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Cyrl.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.sr_Cyrl.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Cyrl.xlf'], 'sr_Latn' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Latn.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.sr_Latn.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Latn.xlf'], 'sv' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.sv.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.sv.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.sv.xlf'], 'th' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.th.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.th.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.th.xlf'], 'tl' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.tl.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.tl.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.tl.xlf'], 'tr' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.tr.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.tr.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.tr.xlf'], 'uk' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.uk.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.uk.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.uk.xlf'], 'ur' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.ur.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.ur.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.ur.xlf'], 'uz' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.uz.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.uz.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.uz.xlf'], 'vi' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.vi.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.vi.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.vi.xlf'], 'zh_CN' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.zh_CN.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.zh_CN.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.zh_CN.xlf'], 'zh_TW' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations\\validators.zh_TW.xlf', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations\\validators.zh_TW.xlf', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations\\security.zh_TW.xlf']], 'scanned_directories' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations', 3 => 'E:\\website-skeleton/translations', 4 => 'E:\\website-skeleton\\vendor\\symfony\\framework-bundle/translations', 5 => 'E:\\website-skeleton\\vendor\\doctrine\\doctrine-bundle/translations', 6 => 'E:\\website-skeleton\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 7 => 'E:\\website-skeleton\\vendor\\symfony\\debug-bundle/translations', 8 => 'E:\\website-skeleton\\vendor\\symfony\\twig-bundle/translations', 9 => 'E:\\website-skeleton\\vendor\\symfony\\web-profiler-bundle/translations', 10 => 'E:\\website-skeleton\\vendor\\twig\\extra-bundle/translations', 11 => 'E:\\website-skeleton\\vendor\\symfony\\security-bundle/translations', 12 => 'E:\\website-skeleton\\vendor\\symfony\\monolog-bundle/translations', 13 => 'E:\\website-skeleton\\vendor\\symfony\\maker-bundle\\src/translations', 14 => 'E:\\website-skeleton\\vendor\\sensio\\framework-extra-bundle\\src/translations', 15 => 'E:\\website-skeleton\\vendor\\symfony\\webpack-encore-bundle\\src/translations', 16 => 'E:\\website-skeleton\\vendor\\zenstruck\\foundry\\src/translations'], 'cache_vary' => ['scanned_directories' => [0 => 'E:\\website-skeleton\\vendor\\symfony\\validator/Resources/translations', 1 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/translations', 2 => 'E:\\website-skeleton\\vendor\\symfony\\security-core/Resources/translations', 3 => 'translations', 4 => 'E:\\website-skeleton\\vendor\\symfony\\framework-bundle/translations', 5 => 'E:\\website-skeleton\\vendor\\doctrine\\doctrine-bundle/translations', 6 => 'E:\\website-skeleton\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 7 => 'E:\\website-skeleton\\vendor\\symfony\\debug-bundle/translations', 8 => 'E:\\website-skeleton\\vendor\\symfony\\twig-bundle/translations', 9 => 'E:\\website-skeleton\\vendor\\symfony\\web-profiler-bundle/translations', 10 => 'E:\\website-skeleton\\vendor\\twig\\extra-bundle/translations', 11 => 'E:\\website-skeleton\\vendor\\symfony\\security-bundle/translations', 12 => 'E:\\website-skeleton\\vendor\\symfony\\monolog-bundle/translations', 13 => 'E:\\website-skeleton\\vendor\\symfony\\maker-bundle\\src/translations', 14 => 'E:\\website-skeleton\\vendor\\sensio\\framework-extra-bundle\\src/translations', 15 => 'E:\\website-skeleton\\vendor\\symfony\\webpack-encore-bundle\\src/translations', 16 => 'E:\\website-skeleton\\vendor\\zenstruck\\foundry\\src/translations']]], []);
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'E:\\website-skeleton');
        $a->addPath('E:\\website-skeleton\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $a->addPath('E:\\website-skeleton\\vendor\\doctrine\\doctrine-bundle/Resources/views', '!Doctrine');
        $a->addPath('E:\\website-skeleton\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', 'DoctrineMigrations');
        $a->addPath('E:\\website-skeleton\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', '!DoctrineMigrations');
        $a->addPath('E:\\website-skeleton\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('E:\\website-skeleton\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('E:\\website-skeleton\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('E:\\website-skeleton\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('E:\\website-skeleton\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('E:\\website-skeleton\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('E:\\website-skeleton/templates');
        $a->addPath('E:\\website-skeleton\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('E:\\website-skeleton\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('E:\\website-skeleton\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($d, 'E:\\website-skeleton', 'UTF-8'));
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings([0 => 'E:\\website-skeleton\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    {
        return $this->privates['var_dumper.server_connection'] = new \Symfony\Component\VarDumper\Server\Connection('tcp://'.$this->getEnv('string:VAR_DUMPER_SERVER'), ['source' => new \Symfony\Component\VarDumper\Dumper\ContextProvider\SourceContextProvider('UTF-8', 'E:\\website-skeleton', ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService())), 'request' => new \Symfony\Component\VarDumper\Dumper\ContextProvider\RequestContextProvider(($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack()))), 'cli' => new \Symfony\Component\VarDumper\Dumper\ContextProvider\CliContextProvider()]);
    }
    ...
    {
        return [
            'kernel.project_dir' => 'E:\\website-skeleton',
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'E:\\website-skeleton\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'E:\\website-skeleton\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'E:\\website-skeleton\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'DebugBundle' => [
                    'path' => 'E:\\website-skeleton\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'TwigBundle' => [
                    'path' => 'E:\\website-skeleton\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'E:\\website-skeleton\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'TwigExtraBundle' => [
                    'path' => 'E:\\website-skeleton\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'E:\\website-skeleton\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'MonologBundle' => [
                    'path' => 'E:\\website-skeleton\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'MakerBundle' => [
                    'path' => 'E:\\website-skeleton\\vendor\\symfony\\maker-bundle\\src',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'SensioFrameworkExtraBundle' => [
                    'path' => 'E:\\website-skeleton\\vendor\\sensio\\framework-extra-bundle\\src',
                    'namespace' => 'Sensio\\Bundle\\FrameworkExtraBundle',
                ],
                'WebpackEncoreBundle' => [
                    'path' => 'E:\\website-skeleton\\vendor\\symfony\\webpack-encore-bundle\\src',
                    'namespace' => 'Symfony\\WebpackEncoreBundle',
                ],
                'ZenstruckFoundryBundle' => [
                    'path' => 'E:\\website-skeleton\\vendor\\zenstruck\\foundry\\src',
            ...
            'translator.default_path' => 'E:\\website-skeleton/translations',
            ...
            'twig.default_path' => 'E:\\website-skeleton/templates',
